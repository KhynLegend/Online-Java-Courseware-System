...
<br>
<label>
  section_id  <input name="sec_id" type="text">
</label>
<br>
<label>
  a. <input name="ques_1" type="text">
</label>
<br>
<label>
  b. <input name="ques_2" type="text">
</label>
<br>
<label>
  c. <input name="ques_3" type="text">
</label>
<br>
<label>
  d. <input name="ques_4" type="text">
</label>
</form>
Hello World:
...
Para marun natin ang ating program, ang <b>main</b> method ay dapat na identical to this signature:
...
-static: method na kayang mag run kahit hindi na gumawa ng instance ng isang class na nagtataglay ng main method<br>
-void: method na hindi nag re-return ng kahit anong value<br>
-main: pangalan ng method<br>
